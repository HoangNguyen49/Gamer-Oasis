                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="footer-logo">
                                ...
                                <p class="info">
                                    We provide high-quality tech products, from laptops to DualSense controllers and
                                    Nintendo consoles. Ensuring you always have the best experience with our products.
                                </p>
                            </div>
                            <ul class="des">
                                <li>
                        ...
                        <div class="col-lg-4">
                            <div class="footer-block">
                                ...
                                <ul class="social-link">
                                    <li class="twitter">
                                        <a href="https://x.com/fpt_aptech" data-toggle="tooltip" target="_blank"
                                            title="X">
                                            <i class="fa-brands fa-x-twitter"></i>
                                        </a>
                                    </li>
                                    <li class="facebook">
                                        <a href="https://www.facebook.com/aptech.fpt" data-toggle="tooltip"
                                            target="_blank" title="Facebook">
                                            <i class="fa fa-facebook"></i>
                                        </a>
                                    </li>
                                    <li class="instagram">
                                        <a href="https://www.instagram.com/fptaptech1999" data-toggle="tooltip"
                                            target="_blank" title="Instagram">
                                            <i class="fa-brands fa-instagram"></i>
                                        </a>
                                    </li>
                                    <li class="youtube">
                                        <a href="https://www.youtube.com/@laptrinhfptaptech" data-toggle="tooltip"
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="text-center mt-3" style="font-size: 13px;">
                            <p><b>&copy;
                                ...
                                </b>. All rights reserved. High-quality products designed to fit your needs, with a
