                        ...
                        <div class="col-lg-5 col-md-6">
                            ...
                            <div class="product-details-left">
                                <div class="product-details-images slider-navigation-1">
                                    @foreach ($product->images as $image) <!-- Hiển thị hình ảnh sản phẩm -->
                                        <div class="lg-image">
                                ...
                                <div class="product-details-thumbs slider-thumbs-1">
                                    @foreach ($product->images as $image) <!-- Hiển thị thumbnail -->
                                        <div class="sm-image">
                                            <img src="{{ asset('storage/' . $image->Image_path) }}" alt="{{ $product->Product_name }} thumbnail">
                                        </div>
                                    @endforeach
                                </div>
                            </div>
                        ...
                        <div class="col-lg-7 col-md-6">
                            <div class="product-details-view-content pt-60">
                                <div class="product-info">
                                    ...
                                    <span class="product-details-ref">Reference: {{ $product->Product_id }}</span> <!-- Reference hoặc ID sản phẩm -->
                                    <div class="rating-box pt-20">
                                        <ul class="rating rating-with-review-item">
                                            <!-- Có thể thêm logic cho đánh giá -->
                                    ...
                                    <div class="price-box pt-20">
                                        <span class="new-price new-price-2">${{ number_format($product->Price, 2) }}</span> <!-- Giá sản phẩm -->
                                    </div>
                                    <div class="product-desc">
                                        <p>{{ $product->Product_description }}</p> <!-- Mô tả sản phẩm -->
                                    </div>
                                    <div class="product-variants">
                                        <div class="product-variants-size">
                                            <label>Product Color</label>
                                            <select class="nice-select">
                                                @foreach ($product->colors as $color) <!-- Hiển thị màu sắc -->
                                                    <option value="{{ $color->Product_Colors_id }}">{{ $color->Color_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="single-add-to-cart">
                                        <form action="#" class="cart-quantity">
                                            ...
                                            <button class="add-cart active"><a href="#" class="add-to-cart-btn" data-product-id="{{ $product->Product_id }}">ADD TO CART</a></button>
                                        </form>
                                    </div>
                                    <div class="product-additional-info pt-25">
                                        <a href="#" class="add-to-wishlist-btn" data-product-id="{{ $product->Product_id }}"><i class="fa fa-heart-o"></i></a>
                                    </div>
