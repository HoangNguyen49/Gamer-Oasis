    ...
    public function store(Request $request)
{
    ...
    return view('admin.pages.quanliblog', compact('topBlogs', 'blogs'));
}
    ...
    public function update(Request $request, $id)
{
    ...
    return redirect()->route('index')->with('success', 'Blog đã được cập nhật thành công!');
}
    ...
    public function destroy($id)
{
    ...
    if ($blog) {
        ...
        return response()->json(['success' => 'Bạn đã xóa blog thành công!']);
    }
    ...
    public function storeComment(Request $request, $slug)
{
    ...
    return redirect()->route('show', ['slug' => $slug])->with('success', 'Bình luận đã được thêm thành công!');
}
